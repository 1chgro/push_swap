...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/20 18:31:41 by olachgue          #+#    #+#             */
/*   Updated: 2025/02/20 18:32:36 by olachgue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_stack	*validate_and_add_num(char *word, t_stack *stack_a)
{
	long	num;
...
static t_stack	*process_argument(char *arg, t_stack *stack_a)
{
	int		j;
	char	*word;
